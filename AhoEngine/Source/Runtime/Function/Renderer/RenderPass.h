...
namespace Aho {
	...
	public:
		...
		virtual void SetRenderCommand(const std::shared_ptr<RenderCommandBuffer> renderCommandBuffer) { m_RenderCommandBuffer = renderCommandBuffer; }
		...
		virtual std::shared_ptr<RenderCommandBuffer> GetRenderCommandBuffer() { return m_RenderCommandBuffer; }
	...
	protected:
		...
		std::shared_ptr<RenderCommandBuffer> m_RenderCommandBuffer{ nullptr };
