...
namespace Aho {
	...
	extern void FillDirectionalLightStruct(GPU_DirectionalLight& gpu_light, const std::shared_ptr<DirectionalLight>& light);
	...
	struct alignas(16) GPU_DirectionalLight {
		...
		GPU_DirectionalLight() = default;
		GPU_DirectionalLight(const glm::mat4& mat, const glm::vec3& dir, const glm::vec3& col = glm::vec3(1.0), float intensity = 1.0)
	...
	struct alignas(16) LightUBO {
		...
		GPU_DirectionalLight u_DirLight[MAX_LIGHT_CNT];
